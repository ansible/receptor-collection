...
| __receptor_replace_tls__              | string       | `true`                                                      | If true, upload and replace existing TLS certificate and keys. If false, they will only be uploaded if the files are not present on the node.                                                                                                                                                                                 |
