...
This project uses [SonarCloud](https://sonarcloud.io/summary/new_code?id=ansible_receptor-collection)
for continuous code quality analysis.

- __Quality Analysis__: All pull requests are automatically analyzed for code quality
- __Quality Gate__: New code must meet quality standards including maintainability,
reliability, and security
- __Dynamic Analysis__: SonarCloud performs continuous code quality checks on all contributions

__Note__: This is an Ansible collection with YAML-based roles. Testing is performed using Molecule.
...
please open an issue in our [GitHub project](https://github.com/ansible/receptor-collection).
...
Ansible Automation Platform (AAP) using the __Create issue__ button on the top right corner.
